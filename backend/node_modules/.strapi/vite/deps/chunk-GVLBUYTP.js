...
} from "./chunk-E3ZKVPED.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-SDX5MSYR.js";
import {
  require_pick
} from "./chunk-3KDCZIFB.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-XIAGMSXU.js";
import {
  require_baseRest
} from "./chunk-C3H5XLF4.js";
import {
  HistoryProvider
} from "./chunk-FKJC625C.js";
import {
  getBasename
...
import {
  ...
  getEERoutes
} from "./chunk-EFXXI5DH.js";
import {
  Login
} from "./chunk-DDCH5SNF.js";
import {
  MemoizedInputRenderer
} from "./chunk-52K26VGQ.js";
import {
  Form
...
} from "./chunk-JV2ZO7HZ.js";
import {
  ConfigurationProvider
} from "./chunk-KBTD6JUG.js";
import {
  GuidedTourContext,
  useAIAvailability
...
import {
  useGetAiUsageQuery
} from "./chunk-YBIMD2E3.js";
import {
  useEnterprise
} from "./chunk-VF5HBU5G.js";
import {
  _setPrototypeOf
...
import {
  ...
  TrackingProvider,
  useTracking
} from "./chunk-R3XTXSKQ.js";
import {
  require_isEqual
} from "./chunk-KVWVHPCR.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-6MIMYMKF.js";
import {
  Page,
  l1,
  useAPIErrorHandler
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-EXRXZIF5.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-XNNYAYZP.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-5NBGJQ5J.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-NE537TKK.js")).FORMS, {
...
var ADMIN_TOKEN_ROUTES = [
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-TY6S6FNO.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-N3R5QZ73.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-2CPOGXM4.js");
      return {
...
var ROUTES_CE = () => [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-SPFFGLN7.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-6NANOR4D.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-6FOQQXEU.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-HTOSHVHD.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-J2UYZQ4D.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-QZFRXZ6K.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-SVK2KJE5.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-NF6RO6YS.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-HCISYOCL.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-6YDQU3AR.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-F76CZXOI.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-2WBWWLE4.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-YBCPABSE.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-5CUHEDP2.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-2Y65Q5KK.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-5ZNZMBFU.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-3XZHKYLF.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-43OGA4KF.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-3XDRX6UW.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-ALDVQWTL.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-ZMUKNKAE.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-DUEHEIYF.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-ONVSWEJ4.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-YU3FPRJO.js");
              return {
...
function __variableDynamicImportRuntime5__(path) {
  switch (path) {
    ...
    case "./translations/tr.json":
      return import("./tr.json-HPYE7GO7.js");
    case "./translations/uk.json":
      return import("./uk.json-5C5AGCAL.js");
    case "./translations/vi.json":
      return import("./vi.json-E2IDTFW7.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-IZVZFGJ2.js");
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-D7IJGBOW.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
...
var ADMIN_LOCALE_LEGACY_ALIASES = {
  da: "dk"
};
...
var StrapiApp = class {
  ...
  async register(customRegister) {
    const widgets = [
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-KLTSKV6H.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-KLTSKV6H.js");
    ...
    if ("strapi-cloud" in this.appPlugins) {
      widgets.push({
        ...
        component: async () => {
          const { DeployNowWidget } = await import("./Widgets-KLTSKV6H.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-EXDDPYPH.js");
  ...
  mergePluginTranslationsByCanonical(pluginTradsBatch) {
    return pluginTradsBatch.reduce((acc, current) => {
      ...
      if (current.locale !== canonicalLocale && Object.keys(current.data).length > 0) {
        ...
        if (!this.warnedLegacyLocalePairs.has(deprecationKey)) {
          ...
          console.warn(`[deprecated] Admin locale "${current.locale}" is deprecated. Rename translation files to "${canonicalLocale}.json".`);
        }
      }
      return acc;
    }, {});
  ...
  */
  async loadTrads(customTranslations = {}) {
    const normalizedCustomTranslations = Object.keys(customTranslations).reduce((acc, key) => {
    ...
    const localesForPlugins = (0, import_uniq.default)(this.configurations.locales.flatMap((locale) => {
  ...
  render() {
    ...
    const locale = normalizeAdminLocale(storedLocale);
  ...
  constructor({ config, appPlugins } = {}) {
    this.plugins = {};
    this.hooksDict = {};
    this.warnedLegacyLocalePairs = /* @__PURE__ */ new Set();
    this.admin = {
      injectionZones: {}
    };
    this.translations = {};
    ...
    this.createCustomConfigurations = (customConfig) => {
      ...
      if (customConfig.locales) {
        const extraLocales = ((_a = customConfig.locales) == null ? void 0 : _a.filter((loc) => loc !== "en").map((loc) => normalizeAdminLocale(loc))) || [];
        this.configurations.locales = (0, import_uniq.default)([
          "en",
          ...extraLocales
        ]);
      }
...
//# sourceMappingURL=chunk-GVLBUYTP.js.map
