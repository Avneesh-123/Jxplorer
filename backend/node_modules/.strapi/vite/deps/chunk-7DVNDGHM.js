...
import {
  LimitsModal,
  useReviewWorkflows
} from "./chunk-PEAU4NVR.js";
import {
  useTypedSelector
} from "./chunk-TGL3FZCW.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-UOZQD7J4.js";
import {
  getStageColorByHex
} from "./chunk-BYW7STR4.js";
import {
...
} from "./chunk-JVHG5734.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-3AV4KESM.js";
import {
  index
} from "./chunk-KA2X7J6E.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-WTQTVORX.js";
import {
  useConfig
} from "./chunk-5PGDUMDT.js";
import {
  Drawer,
  abortUpload,
  cancelUpload,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-JJBARPCN.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-SO2KSRND.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-WMENXESA.js";
import {
  renderAdmin,
  require_baseUniq,
  useDebounce
...
import {
  ...
  Formik,
  useFormik
} from "./chunk-D56NH3FW.js";
import {
  useAdminUsers
} from "./chunk-VB7A4GKK.js";
import {
  useField,
  useForm
...
import {
  useLicenseLimits
} from "./chunk-BVG5WLDV.js";
import {
  Table,
  useTable
} from "./chunk-XXNZH53E.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3,
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case "./translations/da.json":
      return import("./da.json-QB2KGKUC.js");
    ...
    case "./translations/sk.json":
      return import("./sk.json-PQ7ACHOO.js");
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-EQA6XKVI.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
function __variableDynamicImportRuntime1__2(path) {
  switch (path) {
    ...
    case "./translations/da.json":
      return import("./da.json-ZK7G23YZ.js");
    case "./translations/de.json":
    ...
    case "./translations/sk.json":
      return import("./sk.json-2S3WPNPN.js");
    case "./translations/th.json":
...
var admin = {
  ...
  register(app) {
    app.addSettingsLink({
      ...
      id: "settings",
      to: "email",
      Component: () => import("./Settings-QKY2NH7P.js").then((mod) => ({
...
var DialogHeader = ({ handleClose }) => {
  const { formatMessage } = useIntl();
  const { isMinimized, files, uploadId, totalFiles } = useTypedSelector2((state) => state.uploadProgress);
  const progress = useTypedSelector2(selectAggregateProgress);
...
`;
var DeterminateBar = ({ percent }) => {
  const clamped = Math.min(100, Math.max(0, Math.round(percent)));
  return (0, import_jsx_runtime16.jsx)(ProgressTrack, {
    role: "progressbar",
    "aria-valuemin": 0,
    "aria-valuemax": 100,
    "aria-valuenow": clamped,
    children: (0, import_jsx_runtime16.jsx)(ProgressIndicator, {
      $percent: clamped
    })
  });
};
  ...
  if (isCurrentFile) {
    ...
    return (0, import_jsx_runtime16.jsxs)(FileRow, {
      ...
      children: [
        ...
        (0, import_jsx_runtime16.jsx)(DeterminateBar, {
          percent
        })
      ]
    });
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/da.json":
      return import("./da.json-Z5WNFYEH.js");
    case "./translations/de.json":
      return import("./de.json-UL6EZ57I.js");
    case "./translations/en.json":
      return import("./en.json-6N5VIWRU.js");
    case "./translations/es.json":
    ...
    case "./translations/sk.json":
      return import("./sk.json-AH6QYIOS.js");
    case "./translations/th.json":
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-AYJVWCGM.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-N2VSJRAX.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      Component() {
        return import("./SettingsPage-TUTXGFVW.js").then((mod) => ({
          default: mod.ProtectedSettingsPage
        }));
      },
...
function __variableDynamicImportRuntime1__3(path) {
  switch (path) {
    ...
    case "./translations/da.json":
      return import("./da.json-RFQERNUD.js");
    case "./translations/de.json":
      return import("./de.json-BCMVU5IJ.js");
    case "./translations/en.json":
      return import("./en.json-W26MAW2Z.js");
    case "./translations/es.json":
      return import("./es.json-ASNZQTVF.js");
    case "./translations/fr.json":
      return import("./fr.json-RNMMSXHA.js");
    case "./translations/ko.json":
      return import("./ko.json-6VRYKTVU.js");
    case "./translations/nl.json":
      return import("./nl.json-NWR22CNP.js");
    case "./translations/pl.json":
      return import("./pl.json-HP4N4TOE.js");
    case "./translations/ru.json":
      return import("./ru.json-MFOVXBQZ.js");
    case "./translations/sk.json":
      return import("./sk.json-PCVMALZY.js");
    case "./translations/tr.json":
      return import("./tr.json-F7UQH26U.js");
    case "./translations/uk.json":
      return import("./uk.json-HPAKS75W.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-622CVQAO.js");
    case "./translations/zh.json":
      return import("./zh.json-DEPIRTVU.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-X5NILPDW.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/sk.json":
      return import("./sk.json-UB4I5BQ4.js");
    case "./translations/uk.json":
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-D64C6X5M.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./ReleasesSettingsPage-LGD26VTX.js").then((mod) => ({
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-ABVLUZKO.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./PurchaseContentReleases-3NQBK7SE.js").then((mod) => ({
...
function __variableDynamicImportRuntime3__2(path) {
  switch (path) {
    ...
    case "./translations/sk.json":
      return import("./sk.json-BFMNYL5Q.js");
    case "./translations/uk.json":
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./router-2G56NKQD.js").then((mod) => ({
            default: mod.Router
          }));
        }
      });
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-NT4Z3XFX.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./purchase-review-workflows-FAZKQBZX.js").then((mod) => ({
...
//# sourceMappingURL=chunk-7DVNDGHM.js.map
