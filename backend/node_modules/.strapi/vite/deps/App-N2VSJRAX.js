import {
  ...
  validateUrls
} from "./chunk-5AVLP4ZB.js";
import "./chunk-ZKKX5PUT.js";
import "./chunk-GVLBUYTP.js";
import "./chunk-E3ZKVPED.js";
import "./chunk-7EXARAD4.js";
import "./chunk-SDX5MSYR.js";
import "./chunk-3KDCZIFB.js";
import "./chunk-6CNLX22U.js";
import "./chunk-UPGSL6V4.js";
import "./chunk-XIAGMSXU.js";
import "./chunk-JRCQYP7F.js";
import "./chunk-C3H5XLF4.js";
import "./chunk-D56NH3FW.js";
import "./chunk-RZPS7RR6.js";
import "./chunk-FKJC625C.js";
import "./chunk-TKXHHSNW.js";
import {
  useClipboard
} from "./chunk-MTGYL5CH.js";
import "./chunk-EFXXI5DH.js";
import "./chunk-UEGDFTD5.js";
import {
  getDisplayName
} from "./chunk-YFV7NR6Y.js";
import "./chunk-3T3YEEYS.js";
import "./chunk-VB7A4GKK.js";
import "./chunk-DDCH5SNF.js";
import "./chunk-52K26VGQ.js";
import {
  Blocker,
  Form,
  useField,
  useForm
} from "./chunk-FCZMVDVY.js";
import "./chunk-JV2ZO7HZ.js";
import "./chunk-KBTD6JUG.js";
import {
  usePersistentState
} from "./chunk-T6DECA63.js";
import "./chunk-YBIMD2E3.js";
import "./chunk-VF5HBU5G.js";
import "./chunk-LNWCRY6L.js";
import "./chunk-MBK4V2X7.js";
import "./chunk-BVG5WLDV.js";
import "./chunk-XXNZH53E.js";
import {
  Layouts,
  useElementOnScreen
} from "./chunk-RVXJKCY5.js";
import {
  useIsMobile
} from "./chunk-XTUTEU46.js";
import "./chunk-IFOFBKTA.js";
import "./chunk-O7LEIEBU.js";
import "./chunk-A6QRMII5.js";
import "./chunk-ZFX6NEWW.js";
import "./chunk-L4VZK4CF.js";
import "./chunk-R3XTXSKQ.js";
import "./chunk-KVWVHPCR.js";
import "./chunk-6MIMYMKF.js";
import {
  Page
} from "./chunk-H2XZTO3E.js";
import {
  useQueryParams
} from "./chunk-22TZQ4VF.js";
import "./chunk-MITIZ55E.js";
import "./chunk-LHCRHSEP.js";
import {
  useNotification
} from "./chunk-QI4XOG4W.js";
import "./chunk-57KJPCGG.js";
import "./chunk-NR6XEPE4.js";
import {
  useIntl
} from "./chunk-3WNLHS2C.js";
import "./chunk-3MST3H25.js";
import {
  Route,
  Routes
} from "./chunk-25J5DAB7.js";
import "./chunk-AHJOALQ2.js";
import "./chunk-U5ASKYVL.js";
import "./chunk-QQEUXDAQ.js";
import "./chunk-LHXIEHKN.js";
import {
  Cm,
  Fn,
  I,
  ...
  xo,
  zn
} from "./chunk-EIIJRQX7.js";
import "./chunk-QSB6YGVR.js";
...
import "./chunk-4MZT7456.js";
import "./chunk-QBO3FZHQ.js";
import {
  require_react_dom
  ...
  endpoints: (builder) => ({
    ...
    */
    getAllFolders: builder.query({
      ...
      transformResponse: (response) => (response == null ? void 0 : response.data) ?? response ?? [],
      providesTags: (results) => {
        if (results) {
          return [
            ...results.map(({ id }) => ({
...
var { useCreateFolderMutation, useGetFoldersQuery, useGetFolderQuery, useGetAllFoldersQuery } = foldersApi;
...
var { useGetAssetsQuery, useGetAssetQuery, useUpdateAssetMutation, useReplaceAssetMutation, useDeleteAssetMutation } = assetsApi;

// node_modules/@strapi/upload/dist/admin/future/services/settings.mjs
var settingsApi = uploadApi.injectEndpoints({
  endpoints: (builder) => ({
...
var { useGetSettingsQuery } = settingsApi;

// node_modules/@strapi/upload/dist/admin/future/utils/downloadFile.mjs
...
var AssetPreview = ({ asset, actions, isLoading = false }) => {
  const { formatMessage } = useIntl();
  const { alternativeText, ext, mime, url, updatedAt } = asset;
  const cacheKey = updatedAt ? new Date(updatedAt).getTime() : void 0;
  const appendCacheBuster = (raw) => {
    if (!raw || cacheKey === void 0) return raw;
  ...
  if (mime == null ? void 0 : mime.includes(AssetType.Image)) {
    ...
    if (imageUrl) {
      return (0, import_jsx_runtime10.jsxs)(PreviewContainer, {
        children: [
          (!isMediaLoaded || isLoading) && (0, import_jsx_runtime10.jsx)(AssetLoader, {}),
          actions ? (0, import_jsx_runtime10.jsx)(ActionsOverlay, {
            children: actions
          }) : null,
...
var DrawerNotifyContext = React17.createContext(null);
var useDrawerNotify = () => {
  const ctx = React17.useContext(DrawerNotifyContext);
  if (!ctx) {
    throw new Error("useDrawerNotify must be used within AssetDetails");
  }
  return ctx;
};
var AssetOperationsContext = React17.createContext(null);
var useAssetOperation = () => {
  const ctx = React17.useContext(AssetOperationsContext);
  if (!ctx) {
...
var useAssetDetailsParam = () => {
  ...
  const [isMounted, setIsMounted] = React17.useState(hasValidId);
  ...
  const onCloseAnimationEnd = React17.useCallback((event) => {
...
`;
var DetailField = ({ name, label, required }) => {
  const { formatMessage } = useIntl();
  ...
  return (0, import_jsx_runtime11.jsxs)(Vm.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime11.jsx)(X0, {
        ...
        endAction: !value ? (0, import_jsx_runtime11.jsx)(Tr, {
          label: emptyTooltipLabel,
          children: (0, import_jsx_runtime11.jsx)(StyledWarning, {
...
var LocationField = ({ label, rootLabel, folders }) => {
  ...
  return (0, import_jsx_runtime11.jsxs)(Vm.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime11.jsxs)(wo, {
        ...
        disabled: isSubmitting,
        children: [
          (0, import_jsx_runtime11.jsx)(xo, {
            value: "",
            children: rootLabel
          }),
          folders.map((folder) => (0, import_jsx_runtime11.jsx)(xo, {
...
var DeleteAssetButton = () => {
  ...
  return (0, import_jsx_runtime11.jsxs)(_m.Root, {
    open: isOpen,
    onOpenChange: setIsOpen,
    children: [
      (0, import_jsx_runtime11.jsx)(_m.Trigger, {
        children: (0, import_jsx_runtime11.jsx)(st, {
          withTooltip: false,
          label: triggerLabel,
          variant: "danger-light",
          children: (0, import_jsx_runtime11.jsx)(bn, {})
        })
      }),
      (0, import_jsx_runtime11.jsxs)(_m.Content, {
        children: [
          (0, import_jsx_runtime11.jsx)(_m.Header, {
            children: formatMessage({
              id: getTranslationKey("asset-details.delete.title"),
              defaultMessage: "Delete this media file?"
            })
          }),
          (0, import_jsx_runtime11.jsx)(_m.Body, {
            icon: (0, import_jsx_runtime11.jsx)(Nn, {
              width: "24px",
              height: "24px",
              fill: "danger600"
            }),
          ...
          (0, import_jsx_runtime11.jsxs)(_m.Footer, {
            children: [
              (0, import_jsx_runtime11.jsx)(_m.Cancel, {
                children: (0, import_jsx_runtime11.jsx)(zn, {
                  variant: "tertiary",
                  disabled: isDeleting,
                  fullWidth: true,
                  children: formatMessage({
              ...
              (0, import_jsx_runtime11.jsx)(_m.Action, {
                children: (0, import_jsx_runtime11.jsx)(zn, {
                  variant: "danger-light",
                  loading: isDeleting,
...
var CopyLinkButton = ({ asset }) => {
  ...
  return (0, import_jsx_runtime11.jsx)(st, {
    withTooltip: false,
    label: formatMessage({
    ...
    variant: "tertiary",
    onClick: handleCopy,
    children: (0, import_jsx_runtime11.jsx)(H3, {})
  });
};
var DownloadAssetButton = ({ asset }) => {
  const { formatMessage } = useIntl();
  const notify = useDrawerNotify();
  ...
  return (0, import_jsx_runtime11.jsx)(st, {
    ...
    children: (0, import_jsx_runtime11.jsx)(B5, {})
  });
};
var ReplaceAssetButton = () => {
  var _a;
  const { formatMessage } = useIntl();
  const { replaceAsset, isReplacing } = useAssetOperation();
  const fileInputRef = React17.useRef(null);
  const [isDialogOpen, setIsDialogOpen] = React17.useState(false);
  const { data: settings } = useGetSettingsQuery();
  const aiEnabled = ((_a = settings == null ? void 0 : settings.data) == null ? void 0 : _a.aiMetadata) ?? false;
  ...
  return (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, {
    children: [
      ...
      (0, import_jsx_runtime11.jsx)(st, {
        ...
        children: (0, import_jsx_runtime11.jsx)(I2, {})
      }),
      (0, import_jsx_runtime11.jsx)(_m.Root, {
        open: isDialogOpen,
        onOpenChange: setIsDialogOpen,
        children: (0, import_jsx_runtime11.jsxs)(_m.Content, {
          children: [
            (0, import_jsx_runtime11.jsx)(_m.Header, {
              children: formatMessage({
            ...
            (0, import_jsx_runtime11.jsx)(_m.Body, {
              ...
              children: (0, import_jsx_runtime11.jsxs)(T, {
                ...
                children: [
                  ...
                  aiEnabled ? (0, import_jsx_runtime11.jsx)(I, {
                    variant: "omega",
                    children: formatMessage({
...
var AssetDetails = ({ asset, closeDetails }) => {
  var _a;
  ...
  const [drawerToast, setDrawerToast] = React17.useState(null);
  React17.useEffect(() => {
    if (!drawerToast) return;
    const timer = window.setTimeout(() => setDrawerToast(null), 5e3);
    return () => window.clearTimeout(timer);
  }, [
    drawerToast
  ]);
  const notify = React17.useCallback((toast) => setDrawerToast(toast), []);
  ...
  const handleReplace = async (file) => {
    ...
    if ("error" in res) {
      ...
      const message = ((_b = (_a2 = error == null ? void 0 : error.data) == null ? void 0 : _a2.error) == null ? void 0 : _b.message) ?? ((_c = error == null ? void 0 : error.data) == null ? void 0 : _c.message) ?? formatMessage({
  ...
  const operations = React17.useMemo(
    () => ({
  ...
  return (
    ...
    (0, import_jsx_runtime11.jsx)(DrawerNotifyContext.Provider, {
      value: notify,
      children: (0, import_jsx_runtime11.jsx)(AssetOperationsContext.Provider, {
        value: operations,
        children: (0, import_jsx_runtime11.jsx)(FormShell, {
          children: (0, import_jsx_runtime11.jsx)(Form, {
            method: "POST",
            initialValues,
            ...
            children: ({ modified, isSubmitting, values, resetForm }) => {
              ...
              return (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, {
                children: [
                  (0, import_jsx_runtime11.jsx)(Blocker, {
                    onProceed: resetForm
                  }),
                  isReplacing || isDeleting ? (0, import_jsx_runtime11.jsx)(DrawerBusyOverlay, {
                  ...
                  drawerToast ? (0, import_jsx_runtime11.jsx)(DrawerToastSlot, {
                  ...
                  (0, import_jsx_runtime11.jsxs)(Drawer.ScrollableContent, {
                    children: [
                      (0, import_jsx_runtime11.jsx)(AssetPreview, {
                        asset,
                        actions: isImage ? (0, import_jsx_runtime11.jsx)(T, {
                          direction: "column",
                          gap: 2,
                          children: (0, import_jsx_runtime11.jsx)(ReplaceAssetButton, {})
                        }) : null
                      }),
                      (0, import_jsx_runtime11.jsxs)(T, {
                        ...
                        children: [
                          ...
                          (0, import_jsx_runtime11.jsx)(LocationField, {
                            label: formatMessage({
                  ...
                  (0, import_jsx_runtime11.jsxs)(T, {
                    ...
                    children: [
                      (0, import_jsx_runtime11.jsxs)(T, {
                        gap: 2,
                        children: [
                          (0, import_jsx_runtime11.jsx)(DeleteAssetButton, {}),
                          (0, import_jsx_runtime11.jsx)(CopyLinkButton, {
                            asset
                          }),
                          (0, import_jsx_runtime11.jsx)(DownloadAssetButton, {
                            asset
                          })
                        ]
                      }),
...
//# sourceMappingURL=App-N2VSJRAX.js.map
