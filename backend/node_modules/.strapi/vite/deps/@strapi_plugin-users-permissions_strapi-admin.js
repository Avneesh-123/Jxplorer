...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/da.json":
      return import("./da.json-7FAYRPKV.js");
    ...
    case "./translations/sk.json":
      return import("./sk.json-VQBUZX3S.js");
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        Component: () => import("./Roles-BSERHRLW.js"),
      ...
      },
      {
        ...
        Component: () => import("./Providers-EZJZKPR3.js"),
      ...
      },
      {
        ...
        Component: () => import("./EmailTemplates-FDYWDPKC.js").then((mod) => ({
      ...
      },
      {
        ...
        Component: () => import("./AdvancedSettings-J4CLDX3B.js").then((mod) => ({
