...
var collectionTypes = {
    async find (ctx) {
        ...
        if (query.publicationFilter !== undefined) {
            ...
            const legacy = strapiUtils.parseHasPublishedVersionQueryParam(query.hasPublishedVersion);
            if (legacy !== undefined) {
                findPageParams.publicationFilter = strapiUtils.hasPublishedVersionBooleanToPublicationFilterMode(legacy);
            }
        }
