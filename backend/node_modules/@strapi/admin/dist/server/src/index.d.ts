...
declare let admin: {
    ...
    services: {
        ...
        'api-token': import("./services/api-token").ContentApiTokenService;
        'api-token-content-api': import("./services/api-token").ContentApiTokenService;
        'api-token-admin': import("./services/api-token").AdminTokenService;
    ...
    controllers: {
        ...
        'admin-token': {
            create(ctx: import("koa").Context): Promise<import("koa").Context | undefined>;
            regenerate(ctx: import("koa").Context): Promise<import("koa").Context | undefined>;
            list(ctx: import("koa").Context): Promise<void>;
            revoke(ctx: import("koa").Context): Promise<import("koa").Context | undefined>;
            get(ctx: import("koa").Context): Promise<void>;
            update(ctx: import("koa").Context): Promise<import("koa").Context | undefined>;
            getOwnerPermissions(ctx: import("koa").Context): Promise<import("koa").Context | undefined>;
        };
        'authenticated-user': {
