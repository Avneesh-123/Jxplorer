import { pagination as paginationUtils } from '@strapi/utils';
...
declare const _default: ({ strapi }: {
    ...
    findAndCountPage: (query?: any) => Promise<{
        results: any;
        pagination: Partial<paginationUtils.PagePatinationInformation | paginationUtils.OffsetPaginationInformation>;
    }>;
