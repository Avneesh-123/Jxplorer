...
declare const _default: () => {
    ...
    controllers: {
        ...
        'admin-upload': {
            ...
            unstable_uploadFile(ctx: import("koa").Context): Promise<import("koa").Context | undefined>;
            unstable_uploadFromUrls(ctx: import("koa").Context): Promise<import("koa").Context | undefined>;
    ...
    services: {
        ...
        upload: ({ strapi }: {
            ...
            findAndCountPage: (query?: any) => Promise<{
                results: any;
                pagination: Partial<import("@strapi/utils/dist/pagination").PagePatinationInformation | import("@strapi/utils/dist/pagination").OffsetPaginationInformation>;
            }>;
        ...
        file: {
            ...
            fetchUrlToInputFile: (url: string, tmpWorkingDirectory: string, sizeLimit?: number | undefined) => Promise<import("./services/file").FetchUrlResult>;
        };
