   ...
   */ function isValidFilename(string) {
    ...
    async function upload({ data, files }, opts) {
        ...
        try {
            ...
            const fileBatches = _.chunk(fileArray.map((file, idx)=>({
                    file,
